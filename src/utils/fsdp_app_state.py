...
class FSDPWorkspaceAppState(Stateful):
    ...
    def state_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "model_averaging": (
                self.model_averaging.state_dict()
                if hasattr(self.model_averaging, "state_dict")
                else {}
            ),
        }
    ...
    def load_state_dict(self, state_dict: dict[str, Any]) -> None:
        ...
        if hasattr(self.model_averaging, "load_state_dict"):
            self.model_averaging.load_state_dict(state_dict["model_averaging"])
