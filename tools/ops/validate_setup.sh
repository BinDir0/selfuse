...
echo "2. Run smoke test: bash deprecated/scripts/test_smoke.sh /path/to/test_videos 0,1"
echo "3. For production: bash deprecated/scripts/test_production.sh videos.txt 0,1,2,3,4,5,6,7"
echo ""
