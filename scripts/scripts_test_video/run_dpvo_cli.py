...
# 确保项目根目录在 sys.path 中，这样可以正确导入 lib.pipeline.*
THIS_FILE = Path(__file__).resolve()
PROJECT_ROOT = THIS_FILE.parents[2]  # .../RoWaH
if str(PROJECT_ROOT) not in sys.path:
    sys.path.insert(0, str(PROJECT_ROOT))

from lib.pipeline.frame_source import build_frame_source  # noqa: E402
from lib.pipeline.masked_droid_slam import est_calib  # noqa: E402
from lib.pipeline.dpvo_slam import run_dpvo_slam  # noqa: E402
